...
public class Chapter25_2<E extends Comparable<E>> extends AbstractTree<E> {
...
// Case 1: current has no left child
    ...
    public void breadthFirstTraversal() {
        ...
        System.out.println(); // Optional: Print a newline after the traversal
    }
    public int height() {
        return height(root);
    }
    ...
    public boolean isFullBST() {
        ...
        // Check if the number of nodes matches the formula for a full binary tree
        return nodeCount == Math.pow(2, treeDepth) - 1;
    }
